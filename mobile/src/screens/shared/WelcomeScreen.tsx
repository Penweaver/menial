    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.privacyNote}>
          By continuing, you agree to Menial's Terms of Service and NDPA-compliant privacy policy. All financial transactions are protected by bank-grade security.
        </Text>
      </ScrollView>
    </View>
  );
